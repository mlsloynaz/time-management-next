...
export function TmButton(props: TmButtonProps) {
    ...
    const classButton = "text-black bg-[#E4E6F9] e border border-indigo-800 focus:outline-none hover:bg-slate-200 focus:ring-4 focus:ring-[#464CD4] font-medium rounded-lg text-sm px-4 py-2 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700";
